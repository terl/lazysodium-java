...
public interface SecretStream {
    ...
    byte XCHACHA20POLY1305_TAG_PUSH = 0x01,
        ...
        XCHACHA20POLY1305_TAG_MESSAGE = 0x02,
    ...
    byte TAG_PUSH = 0x01,
         TAG_REKEY = 0x02,
         TAG_FINAL = XCHACHA20POLY1305_TAG_PUSH | XCHACHA20POLY1305_TAG_REKEY,
    ...
    interface Lazy {
         ...
         */
        String cryptoSecretStreamKeygen();
         ...
         * secret stream.
         */
        State cryptoSecretStreamInitPush(byte[] header, String key) throws SodiumException;


        /**
         * Encrypt a {@code message}.
         * @param state State as initialised in {@link #cryptoSecretStreamInitPush(byte[], String)}.
         * @param message The message to encrypt.
         * @param tag The tag.
         ...
         */
        State cryptoSecretStreamInitPull(byte[] header, String key) throws SodiumException;


        /**
         * Decrypt a message without additional data.
         * @param state The state as generated by {@link #cryptoSecretStreamInitPull(byte[], String)}.
         * @param tag The tag.
         * @param cipher The resulting encrypted message.
