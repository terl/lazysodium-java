...
public interface SecretBox {
    ...
    interface Native {
        ...
        /**
         * Generates a key for XSalsa20Poly1305.
         * @param key The key of size @{@link #XSALSA20POLY1305_KEYBYTES}
         * @return True if successful.
         */
        boolean cryptoSecretBoxXSalsa20Poly1305Keygen(byte[] key);

        /**
         * Encrypts a message using XSalsa20Poly1305.
         * @param message The message length which is the same size as {@code cipherTextLen}.
         * @param cipher The cipher text.
         * @param messageLen The message length.
         * @param nonce The nonce.
         * @param key The key generated by {@link #cryptoSecretBoxXSalsa20Poly1305Keygen(byte[])}.
         */
        void cryptoSecretBoxXSalsa20Poly1305(byte[] cipher,
                                                 byte[] message,
                                                 long messageLen,
                                                 byte[] nonce,
                                                 byte[] key);
         ...
         * @return True if successful.
         */
        boolean cryptoSecretBoxXSalsa20Poly1305Open(byte[] message,
                                                 byte[] cipher,
                                                 long cipherLen,
                                                 byte[] nonce,
                                                 byte[] key);
