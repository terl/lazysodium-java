...
public interface SecretBox {
    ...
    interface Native {
         ...
         * @param mac The mac.
         * @param cipherTextLen The cipher
    ...
    interface Lazy {
         ...
         * @param key The key. A hexadecimal string that's been through {@link Helpers.Lazy#sodiumBin2Hex(byte[])}.
         * @param charset When converting the message to a string, this is the charset we will use. Put down
         *                null if you provided a default when creating
         *                {@link com.goterl.lazycode.lazysodium.LazySodium#LazySodium(Sodium, Charset)}.
         * @return The decrypted message.
         */
        String cryptoSecretBoxOpenEasy(String cipher, byte[] nonce, String key, Charset charset) throws SodiumException;
