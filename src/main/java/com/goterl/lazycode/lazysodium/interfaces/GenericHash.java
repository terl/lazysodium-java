...
public interface GenericHash {
    ...
    interface Native {
         ...
         *          and {@link #KEYBYTES_MAX}. {@link #KEYBYTES_MIN} is
         *          not recommended and may cause errors.
         */
         ...
         * @param key The key generated by {@link #cryptoGenericHashKeygen(byte[])}.
         *            Note that {@link #KEYBYTES_MIN} is not recommended and may cause errors.
    ...
    interface Lazy {
         ...
         *             {@link #KEYBYTES_MIN} is not recommended and may cause errors.
         *             If you want to bravely use {@link #KEYBYTES_MIN} you can use the native
         *             function {@link GenericHash.Native#cryptoGenericHashKeygen(byte[])}.
         * @return A hashing key.
         * @throws SodiumException If at any point the key generation caused errors.
         * Or if {@code size} is {@link #KEYBYTES_MIN}.
         */
         ...
         * @return True if initialised.
         * @throws SodiumException If the key size is {@link #KEYBYTES_MIN}.
         */
        boolean cryptoGenericHashInit(GenericHash.State state,
                                      String key,
                                      int outLen) throws SodiumException;
